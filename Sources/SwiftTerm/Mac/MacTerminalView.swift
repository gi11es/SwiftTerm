...
open class TerminalView: NSView, NSTextInputClient, NSUserInterfaceValidations, TerminalDelegate {
    ...
    public override func scrollWheel(with event: NSEvent) {
        ...
        // When mouse reporting is active (e.g. tmux `mouse on`), forward scroll
        // events as button-press escape sequences instead of scrolling the
        // internal buffer. Button 4 = scroll up (64), button 5 = scroll down (65).
